package com.dhairyaparikh.textit.Adapters;
...
import com.dhairyaparikh.textit.databinding.DeleteDialogBinding;
import com.dhairyaparikh.textit.databinding.ItemReceiveBinding;
import com.dhairyaparikh.textit.databinding.ItemReceiveGroupBinding;
import com.dhairyaparikh.textit.databinding.ItemSentBinding;
import com.dhairyaparikh.textit.databinding.ItemSentGroupBinding;
...
public class GroupMessagesAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder.getClass() == SentViewHolder.class) {
            ...
            viewHolder.binding.images.setOnTouchListener(new View.OnTouchListener() {
                @Override
                public boolean onTouch(View v, MotionEvent event) {
                    popup.onTouch(v, event);
                    return false;
...
//                    }
            ...
            ReceiverViewHolder viewHolder = (ReceiverViewHolder) holder;
            if(message.getMessage().equals("photo")){
                viewHolder.binding.images2.setVisibility(View.VISIBLE);
                viewHolder.binding.message.setVisibility(View.GONE);
                Glide.with(context)
                        .load(message.getImageUrl())
                        .placeholder(R.drawable.placeholder)
                        .into(viewHolder.binding.images2);
            }
            FirebaseDatabase.getInstance().getReference()
                    .child("users")
                    .child(message.getSenderId())
            ...
            viewHolder.binding.images2.setOnTouchListener(new View.OnTouchListener() {
                @Override
                public boolean onTouch(View v, MotionEvent event) {
                    popup.onTouch(v, event);
                    return false;
